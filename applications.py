...
def get_weather(city: str):
    ...
    """
    try:
        api_key="dd2ac32b3a6df60bcd7fd8d18553d6bc"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="8bb6ca744ce244f48bcd29f8e9a43c85"
...
def find_local_events(city: str):
    ...
    try:
        api_key="7cc1873e8301f3f89c77eb75d9fccf84a4fdf7df0df96fd3ea7fe524ca42bfb9"# used serpapi(google event api)
